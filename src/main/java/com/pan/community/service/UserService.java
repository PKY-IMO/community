...
import com.pan.community.util.CommunityConstant;
import com.pan.community.util.CommunityUtil;
import com.pan.community.util.MailClient;
import com.pan.community.util.RedisKeyUtil;
...
//    private LoginTicketMapper loginTicketMapper;
 ...
 //       return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user) {
        ...
        // http://localhotst:8080/community/ativation/101/code
...
//        loginTicketMapper.insertLoginTicket(loginTicket);
        ...
        String rdeisKey = RedisKeyUtil.getTicketKey(loginTicket.getTicket());
        redisTemplate.opsForValue().set(rdeisKey, loginTicket);
